                            ...
                            child: PopupMenuButton<String>(
                              ...
                              itemBuilder: (BuildContext context) => [
                                PopupMenuItem<String>(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.person, color: AppColors.concolor),
                                      SizedBox(width: 8),
                                ...
                                PopupMenuItem<String>(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.notifications, color: AppColors.concolor),
                                      SizedBox(width: 8),
                                ...
                                PopupMenuItem<String>(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.help, color: AppColors.concolor),
                                      SizedBox(width: 8),
                                ...
                                PopupMenuItem<String>(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.logout, color: AppColors.concolor),
                                      SizedBox(width: 8),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'You have ${_homePageData.tasks.length} Tasks Today',
                            style: GoogleFonts.montserrat(
                              fontSize: 14,
                              color: Colors.grey,
                            ),
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: _homePageData.tasks.length,
                              itemBuilder: (context, index) {
                                final task = _homePageData.tasks[index];
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => EventDetailPage(
                                          ...
                                          status: task.status,
                                          date: task.date, // Ensure this matches the required type
                                          location: task.location,
                                          pdfUrls: task.pdfUrls ?? [],
                                          Event: task.Event,
                                          Assignedby: task.Assignedby,
                                          Attachmentpdfurl: task.Attachmentpdfurl,
                                          // Add any additional parameters if necessary
                                          fromDate: task.date, // Assuming you want to set fromDate
                                          toDate: task.date, // Assuming you want to set toDate
                                          fromTime: "", // Replace with actual fromTime if available
                                          toTime: "", // Replace with actual toTime if available
                                        ),
                                      ),
                                    );
                                  },
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => EventDetailPage(
                                          ...
                                          date: meeting.fromDate, // You can choose to send fromDate or toDate
